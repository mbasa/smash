...
class SL {
  ...
  String get importWidget_importFromGeoTaskTracker {
    return Intl.message(
      'Import from GeoTaskTracker Server',
      name: 'importWidget_importFromGeoTaskTracker',
      desc: '',
      args: [],
    );
  }
  ...
  /// `GeoTaskTracker Server`
  String get settings_geoTaskTrackerServer {
    return Intl.message(
      'GeoTaskTracker Server',
      name: 'settings_geoTaskTrackerServer',
      desc: '',
      args: [],
    );
  }
